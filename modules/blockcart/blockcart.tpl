...
<div style="border-top:1px dashed #429A22;"><img src="{$img_dir}carrito.jpg" alt="Categorias"  width="290" height="50" /></div>
...
{/foreach}
		...
		<p id="cart-buttons">
			...
			<div id="botoncart">
			<a href="{$link->getPageLink("$order_process", true)}" rel="nofollow">Carrito</a>
			</div>
			{/if}
			<div id="botoncheckout">
			<a href="{$link->getPageLink("$order_process", true)}" rel="nofollow">{l s='Check out' mod='blockcart'}</a>
			</div>
		</p>
	</div>
	</div>
